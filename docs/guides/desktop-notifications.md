...
```text
http://127.0.0.1:3000/sessions/<session-id>
```

That page connects to the user's local API. Opening a notification does not
resume, cancel, or otherwise change the session.
